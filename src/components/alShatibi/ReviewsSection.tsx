    ...
    <div className="relative pt-12 md:pt-16 lg:py-16 xl:py-[72px] bg-[rgb(30_21_25/var(--tw-bg-opacity,1))] ">
      <div className="absolute top-0 left-0 w-full rcardbg">
        <img
          ...
          src="https://www.bayyinahtv.com/_nuxt/review-card-bg.pAIk7hWR.png"
          alt="Bg"
        />
      </div>
      <div className="relative z-10 justify-between px-6 md:px-8 lg:px-10 xxl:px-24 md:flex md:gap-x-6 lg:gap-x-8">
        ...
        <AnimateOnScroll
          delay={0.2}
          className="reviewslider md:max-w-[57%] w-full z-10 mt-8 md:mt-0"
        >
          <Swiper
            modules={[Pagination]}
            spaceBetween={24}
            ...
            className="!pr-6 md:!pr-8 lg:!pr-10 xxl:!pr-24"
          >
            {reviews.map((review) => (
              <SwiperSlide key={review.name}>
                <div className="relative p-6 flex flex-col lg:flex-row gap-5 xl:gap-6 2xl:gap-8 rounded-xl md:rounded-2xl xl:rounded-3xl bg-[#111111] border border-[#343434] h-full">
                  <div className="shrink-0">
                    <img
                      src={review.image}
                      className="w-[48px] h-[48px] lg:w-[52px] lg:h-[52px] xl:w-[64px] xl:h-[64px] 2xl:w-[74px] 2xl:h-[74px] rounded-full object-cover object-top"
                      alt={review.name}
                    />
                  </div>
                  <div className="flex flex-col justify-between shrink-0 lg:shrink grow lg:grow-0 lg:justify-start">
                    ...
                    <div className="mt-auto text-base font-semibold text-white lg:text-lg">
                      {review.name}
                    </div>
                  </div>
                </div>
