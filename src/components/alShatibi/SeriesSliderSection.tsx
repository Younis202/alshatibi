...
const ClockIcon = () => (
  ...
  >
    <path
      fill="#FFEADA"
      d="M22.75 14a8.75 8.75 0 1 1-17.5 0 8.75 8.75 0 0 1 17.5 0ZM4 14a10 10 0 1 0 20 0 10 10 0 0 0-20 0Zm9.375-5.625V14c0 .344.281.625.625.625h4.375A.627.627 0 0 0 19 14a.627.627 0 0 0-.625-.625h-3.75v-5A.627.627 0 0 0 14 7.75a.627.627 0 0 0-.625.625Z"
    ></path>
  </svg>
);
...
const PremiumBadge = () => (
  <div className="absolute flex top-[16px] left-[16px] gap-x-1 lg:gap-x-1.5 items-center px-2 py-1 sm:py-1.5 lg:py-2 md:top-[20px] md:left-[20px] rounded-md bg-black bg-opacity-[.85]">
    ...
    >
      <g clipPath="url(#clip0_premium)">
        <path
          ...
          stroke="#CC2002"
          strokeWidth=".25"
          d="M.36 6.589a.433.433 0 0 0 .028.551L9.92 17.595a.428.428 0 0 0 .32.142.428.428 0 0 0 .32-.141l.001-.001L20.09 7.14h.001a.433.433 0 0 0 .028-.552L15.505.439l-.1.074.1-.074a.435.435 0 0 0-.346-.173H5.32a.435.435 0 0 0-.347.173L.361 6.589Zm1.212-.173 3.758-5.01 4.011 5.01h-7.77ZM10.24 16.66 1.685 7.28h17.107l-8.553 9.38Zm4.909-15.255 3.758 5.01h-7.77l4.012-5.01ZM6.218 1.13h8.043L10.24 6.156 6.217 1.131Z"
        ></path>
      </g>
      <defs>
    ...
    <span className="inline-block text-[11px] md:text-xs uppercase mt-1 text-grey-brand">
      Premium
    </span>
  </div>
);
...
const series = [
  {
    title: "The Trial of A'ishah",
    lessons: "6 Lessons",
    duration: "03h 15m",
    tags: ["Quran", "Story Nights"],
    image:
      "https://www.bayyinahtv.com/_nuxt/Honor-The-Trial-of-Aishah-thumb.BavbM8PZ.jpg",
    premium: true,
    href: "/library/series/254",
  },
  {
    title: "Inside Uhud",
    lessons: "2 Lessons",
    ...
    tags: ["Quran", "Story Nights"],
    image:
      "https://www.bayyinahtv.com/_nuxt/Adam-in-the-Angels-Eyes-thumb.JN383PO9.jpg",
    premium: false,
    href: "/library/series/257",
  },
  {
    ...
    duration: "02h 39m",
    tags: ["Quran", "Story Nights"],
    image: "https://www.bayyinahtv.com/_nuxt/sleepers-of-the-cave.CF4WsFvJ.jpg",
    premium: true,
    href: "/library/series/259",
  },
  {
    title: "Adventures of Young Moses",
    lessons: "4 Lessons",
    duration: "03h 37m",
    tags: ["Quran", "Story Nights"],
    image: "https://www.bayyinahtv.com/_nuxt/video-thumb1.Dj3Wfmna.png",
    premium: false,
    href: "/library/series/253",
  },
];
...
const SeriesSliderSection = () => {
  return (
    <div className="relative py-12 md:py-16 lg:py-24 ">
      ...
      <div className="relative z-10 px-6 md:px-8 lg:px-10 xxl:px-24">
        <AnimateOnScroll>
          <div className="flex flex-wrap mb-4 md:mb-6 gap-x-6 sm:gap-x-8 lg:gap-x-12 xl:gap-x-16 item-center lg:mb-8 xl:mb-10">
            <div className="flex items-center gap-2 cursor-pointer md:gap-3 font-heading font-light text-xl sm:text-2xl lg:text-4xl xl:text-6xl dark:text-grey-brand opacity-100">
              <svg
                width="48"
                height="48"
                viewBox="0 0 48 48"
            ...
            <div className="flex items-center gap-2 cursor-pointer md:gap-3 font-heading font-light text-xl sm:text-2xl lg:text-4xl xl:text-6xl dark:text-grey-brand opacity-40">
              <h2 className="text-black text-3xl font-light tab-btn font-heading sm:text-[2rem] md:text-4xl lg:text-5xl xl:text-[3.375rem] 2xl:text-6xl dark:text-grey-brand">
                History
              </h2>
            </div>
        ...
        <AnimateOnScroll delay={0.15}>
          <p className="dark:text-white text-black text-base max-w-[400px] md:max-w-[480px] lg:text-lg xl:text-xl xl:max-w-[530px] w-full">
            Quranic stories come to life—relatable, emotional and timeless
            guidance for the heart, mind and family.
          </p>
        </AnimateOnScroll>
                ...
                <a href={s.href}>
                  <div className="relative flex flex-col h-full overflow-hidden rounded-lg">
                    ...
                    <div className="relative flex flex-col justify-between flex-grow p-5 sm:p-6 lg:py-8 bg-[#4C0B00]">
                      <div className="mb-6 text-lg font-semibold md:mb-8 md:text-xl text-grey-brand">
                        {s.title}
                      </div>
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-x-2 md:gap-x-2.5">
                          {s.tags.map((tag) => (
                            <div
                              key={tag}
                              className="px-2 pt-2 pb-1.5 md:pb-2 md:pt-2.5 text-xs md:text-sm leading-none border rounded text-grey-brand border-grey-brand/40"
                            >
                              {tag}
                            </div>
                          ))}
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-accent-maroon-dark via-transparent to-accent-maroon-dark/30" />
    </div>
  );
};
